...
class Controller
{
    ...
    function __construct($pageID)
    {
        ...
        if ($pageID == 'home'){
            ...
            $this->model->dbInsertDrinkDetails($Id=3, $title='Dr Pepper', $text=$pepperText, $pepperPath);
            $this->model->dbInsertDrinkDetails($Id=1, $title='Coca Cola', $text=$cokeText, $cokePath);
            $this->model->dbInsertDrinkDetails($Id=2, $title='Sprite', $text=$spriteText, $spritePath);
            $this->model->dbInsertDrinkDetails($Id=4, $title='Fanta', $text=$fantaText, $fantaPath);
