...
$modelTexture="";
$modelPath="";
foreach ($handover['costaModelData'] as $key => $value) {
    ...
    <div class="row">
            ...
            <div class="card text-left">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="javascript:swapMainContent(' . $costa . ')">Costa</a></li>
     ...
     <div class="camera-btns">
            <div class="btn-group ">
                ...
                <a href="javascript:changeColor()" class="btn btn btn-responsive">ChangeEnvColor</a>
                <a href="javascript:toggleLight()" class="btn btn btn-responsive">Light</a>
